...
+ (void)drawLine:(CGContextRef)context startPoint:(CGPoint)startPoint endPoint:(CGPoint)endPoint lineColor:(UIColor *)lineColor isNode:(BOOL)isNode {
    ...
    if (isNode) {
        ...
        CGRect rectangle = CGRectMake(endPoint.x - 0.25, endPoint.y - 0.25, 0.5, 0.5);
